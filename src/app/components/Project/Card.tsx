...
export default function Card() {
  return (
    <div className='dark:border-dark-secondary group relative h-36 max-w-[280px] overflow-hidden rounded-lg border border-gray-200 object-cover sm:max-w-[360px] lg:h-44 lg:max-w-[440px] '>
      ...
      <div className='dark:bg-dark-secondary absolute bottom-0 h-10 w-full bg-gray-primary p-2 transition-all group-hover:h-3/4 '>
        <div className='h-20'>
