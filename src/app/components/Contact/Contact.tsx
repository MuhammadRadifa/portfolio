        ...
        {contact.map((contact, index) => {
          ...
          return (
            <a
              key={index}
              href='#'
              className='dark:hover:text-dark-secondary flex h-12 w-12 items-center justify-center rounded-full border-2 border-gray-primary text-2xl hover:bg-black hover:text-white dark:hover:bg-white sm:h-14 sm:w-14 sm:text-3xl lg:h-16 lg:w-16 lg:text-4xl'
            >
              <Icon />
            </a>
          )
